...
public class ApplicationRole : IdentityRole
{
    ...
    public byte TenantType { get; set; } = (byte)Enums.TenantTypeEnum.Default;
    public byte Level { get; set; } = 1;
    public virtual ICollection<ApplicationRoleClaim> RoleClaims { get; set; }
    public virtual ICollection<UserRoleTenant> UserRoles { get; set; }
    //add isActive,activatedBy,deactivatedBy
    public ApplicationRole() : base()
    {
        RoleClaims = new HashSet<ApplicationRoleClaim>();
        UserRoles = new HashSet<UserRoleTenant>();
    }

    public ApplicationRole(RoleNamesEnum roleName, TenantTypeEnum tenantType = Enums.TenantTypeEnum.Default)
        :this(roleName.ToString(),tenantType)
    { }
    public ApplicationRole(string roleName, TenantTypeEnum tenantType = Enums.TenantTypeEnum.Default) : base(roleName)
    {
