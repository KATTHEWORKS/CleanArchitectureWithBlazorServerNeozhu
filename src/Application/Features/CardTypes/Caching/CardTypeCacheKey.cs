...
namespace CleanArchitecture.Blazor.Application.Features.CardTypes.Caching;
/// <summary>
/// Static class for managing cache keys and expiration for CardType-related data.
/// </summary>
public static class CardTypeCacheKey
{
    ...
    public const string GetAllCacheKey = "all-CardTypes";
    public static string GetPaginationCacheKey(string parameters) {
        return $"CardTypeCacheKey:CardTypesWithPaginationQuery,{parameters}";
    }
    public static string GetByNameCacheKey(string parameters) {
        return $"CardTypeCacheKey:GetByNameCacheKey,{parameters}";
    }
    public static string GetByIdCacheKey(string parameters) {
        return $"CardTypeCacheKey:GetByIdCacheKey,{parameters}";
    }
