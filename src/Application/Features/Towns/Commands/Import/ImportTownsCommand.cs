...
{ _localizer[_dto.GetMemberDescription(x=>x.TypeOfProfileId)], (row, item) => item.TypeOfProfileId = int.Parse( row[_localizer[_dto.GetMemberDescription(x=>x.TypeOfProfileId)]].ToString() )}, 
