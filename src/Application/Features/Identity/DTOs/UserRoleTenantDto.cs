...
public class UserRoleTenantDto
{
    ...
    private class Mapping : Profile
    {
        public Mapping()
        {
            CreateMap<UserRoleTenant, UserRoleTenantDto>(MemberList.None)
            ...
            CreateMap<UserRoleTenantDto, UserRoleTenant>(MemberList.None)

                .ForMember(x => x.UserId, s => s.MapFrom(y => y.UserId))
                .ForMember(x => x.TenantId, s => s.MapFrom(y => y.TenantId))
                .ForMember(x => x.RoleId, s => s.MapFrom(y => y.RoleId))
                ;
        }
    }
}
