...
namespace CleanArchitecture.Blazor.Migrators.MSSQL.Migrations
{
    ...
    [Migration("20240217162230_dbJson12345686")]
    partial class dbJson12345686
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.V_VoteSummary", b =>
                {
                    ...
                    b.Property<string>("KPIVotesAsJsonString")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CleanArchitecture.Blazor.Domain.Entities.V_Vote", b =>
                {
                    ...
                    b.OwnsOne("System.Collections.Generic.List<CleanArchitecture.Blazor.Domain.Entities.VoteKPIComment>", "VoteKPIComments", b1 =>
                        {
                            b1.Property<int>("V_VoteId")
                                .HasColumnType("int");
                            ...
                            b1.ToJson("VoteKPIComments");

                            b1.WithOwner()
                                .HasForeignKey("V_VoteId");
                        });

                    b.OwnsOne("System.Collections.Generic.List<CleanArchitecture.Blazor.Domain.Entities.VoteKPIRatingComment>", "VoteKPIRatingComments", b1 =>
                        {
                            b1.Property<int>("V_VoteId")
                                .HasColumnType("int");
                            ...
                            b1.ToJson("VoteKPIRatingComments");
                    ...
                    b.Navigation("VoteKPIComments");

                    b.Navigation("VoteKPIRatingComments");
                });
